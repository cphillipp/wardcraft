<?php get_header(); ?>
	<?php
		...
		if( $gdl_admin_translator == 'enable' ){
			...
			$translator_visit_website = get_option(THEME_SHORT_NAME.'_translator_visit_website', 'Request a Quote');
			...
			$translator_visit_website = __('Request a Quote','gdl_front_end');		
